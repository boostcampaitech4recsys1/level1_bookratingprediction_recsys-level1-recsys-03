...
def process_context_data2(users, books, ratings1, ratings2): # label-encoding 
...
def context_data_load2(args):

    ######################## DATA LOAD
    users = pd.read_csv(args.DATA_PATH + 'age_users.csv')
    books = pd.read_csv(args.DATA_PATH + 'books.csv')
    train = pd.read_csv(args.DATA_PATH + 'train_ratings.csv')
    test = pd.read_csv(args.DATA_PATH + 'age_test.csv')
    ...
    idx, context_train, context_test = process_context_data2(users, books, train, test)
    ...
    data = {
            'train':context_train,
            'test':context_test.drop(['age'], axis=1).drop(['rating'], axis=1),
...
def context_data_split2(args, data):
    X_train, X_valid, y_train, y_valid = train_test_split(
                                                        data['train'].drop(['age'], axis=1).drop(['rating'], axis=1),
                                                        data['train']['age'],
