    ...
    def train(self):
        ...
        for epoch in tk0:
            ...
            if minimum_loss > (val_total_loss/val_n):
                ...
                print('')
                print('train_loss:', total_loss/n, 'valid_loss:', val_total_loss/val_n)
            else:
