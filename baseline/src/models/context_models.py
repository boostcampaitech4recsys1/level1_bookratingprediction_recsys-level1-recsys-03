...
from ._models import _FactorizationMachineModel, _FieldAwareFactorizationMachineModel, _HighOrderFactorizationMachineModel, _DeepFactorizationMachineModel, _FMDCN
...
class FMDCN:
    ...
    def __init__(self, args, data):
        ...
        self.fm_embed_dim = args.FM_EMBED_DIM
        ...
        self.model = _FMDCN(self.field_dims, self.fm_embed_dim, self.dcn_embed_dim, self.mlp_dims, self.dropout, self.num_layers, self.batch_size).to(self.device)
